...
def PrimaryNotchingCalculator(filemanager):
    ...
    h5_notchdata(inputh5,randomspec)
...
def loadallpaths(pathcsv):
    ...
    global inputf06, inputh5, outpath, inputlevels, inputrandom, analysis      
    ...
    inputrandom = allfileslist[3]

    # Get output file paths
    outpath = allfileslist[4]

    if inputrandom == "":
        analysis = "sine"
    else:
        analysis = "random"
    return inputf06, inputh5, outpath, inputlevels, inputrandom, analysis 
